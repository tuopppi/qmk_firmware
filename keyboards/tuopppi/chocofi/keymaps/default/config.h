...
#define ROTATIONAL_TRANSFORM_ANGLE -8 // neg. angle rotates clockwise
...
#define SMTD_GLOBAL_RELEASE_TERM 30 // avoid E>N to become command N (default TAPPING_TERM / 4)
